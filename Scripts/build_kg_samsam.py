...
core_family = "SamSam"  # Change to match your target family
...
# Find all real-case SamSam variants
family_nodes = set()
...
# Build graph and collect direct neighbors for all variants
G = nx.DiGraph()
...
pos = nx.spring_layout(subG, seed=77, k=0.5)
