...
core_family = "NoobCrypt"

# Find all nodes directly connected to NoobCrypt
...
pos = nx.spring_layout(subG, seed=53, k=0.5)
...
plt.title(f'Knowledge Graph: Direct Connections of "NoobCrypt"', fontsize=16, fontweight='bold', color='navy')
plt.axis('off')
plt.tight_layout()
plt.show()
