...
core_family = "Globe"  # Change as needed for case variant
...
# Find all case variants for Globe
family_nodes = set()
...
# Build the graph and gather all direct (1-hop) neighbors for each "Globe"
G = nx.DiGraph()
...
pos = nx.spring_layout(subG, seed=81, k=0.5)
