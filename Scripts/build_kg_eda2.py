...
core_family = "EDA2"  # Core ransomware family
...
# Build the graph; gather direct neighbors (1-hop) for each EDA2 node
G = nx.DiGraph()
...
# Color nodes by type for beauty/clarity
node_colors = []
for n in subG.nodes:
...
pos = nx.spring_layout(subG, seed=85, k=0.5)
