...
core_family = "WannaCry"

# Get direct neighbors (outgoing/incoming) for WannaCry
...
pos = nx.spring_layout(subG, seed=24, k=0.5)
...
plt.title(f'Knowledge Graph: Direct Connections of "WannaCry"', fontsize=16, fontweight='bold', color='navy')
plt.axis('off')
plt.tight_layout()
plt.show()
