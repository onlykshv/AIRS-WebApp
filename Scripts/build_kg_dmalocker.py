...
plt.title(f'Knowledge Graph: Direct Connections of "DMALocker"', fontsize=16, fontweight='bold', color='navy')
plt.axis('off')
plt.tight_layout()
plt.show()
